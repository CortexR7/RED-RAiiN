...
void VULKAN_CMD::RECORD_CMD_BUFFER_GRAPHICS(VkCommandBuffer& CMD_BUFFER, uint32_t imageIndex, VULKAN_SWAPCHAIN& SWAPCHAIN,  VULKAN_PIPELINE& PIPELINE, RE2_VERTEX_BUFFER& VERTEX_BUFFER, RE2_INDEX_BUFFER& INDEX_BUFFER)
{
