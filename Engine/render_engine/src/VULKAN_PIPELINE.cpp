...
void VULKAN_PIPELINE::INIT(VULKAN_LOGICAL_DEVICE& LOGICAL_DEVICE, VULKAN_SWAPCHAIN& SWAPCHAIN)
{
    ...
    VkShaderModule vertexShaderModule = CREATE_SHADER_MODULE(SHADERS[0], LOGICAL_DEVICE);
    VkShaderModule fragmentShaderModule = CREATE_SHADER_MODULE(SHADERS[1], LOGICAL_DEVICE);
